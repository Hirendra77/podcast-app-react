...
import AudioPlayer from '../componenents/Common/Podcasts/AudioPlayer';
import EpisodeDetails from '../componenents/Common/Podcasts/EpisodeDetails';
            ...
            {episodes?.length> 0 ? (<>
              ...
              index={index+1}
                ...
                description={episode.description}
                 ...
                 onClick={(file)=>console.log(setPlayingFile(file))}
                 />
                );
            })}
            </>
